...
#Intrinsic Lengths
dp.mantleCrustDepth=15.*1e3              #Crust depth
dp.faultThickness = 20.*1e3              #interface material (crust) an top of slabs
...
dp.subZoneLoc=6000e3                    #Y position of subduction zone...km
dp.maxDepth=250e3
